...
he ljung-box test indicates autocorrelation of ts, essentially, are residuals independtly distributed (H0) or are they serially correlated. Our p value returned <0.01, indicated there is serial correlation between discharge and phyt abundance (just for lock 9 and anabaena). 
